...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            remote_call_window::remote_call_window_show,
            ...
            remote_call_window::remote_call_window_scene,
            remote_call_window::remote_call_window_read_scene,
            remote_call_window::remote_call_window_scene_entry,
            remote_call_window::remote_call_window_media,
            remote_call_window::remote_call_window_read_media,
