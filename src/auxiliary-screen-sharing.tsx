...
const text = {
  en: {
    ...
    description:
      "Keep these controls beside your work while the resident stays in the small call window.",
    display: "Shared display",
    noDisplays: "No displays available",
    refresh: "Refresh displays",
    interval: "Viewing interval",
    seconds: (value: number) => `${value} seconds`,
    cost: "Screen sharing sends images and uses tokens. Shorter intervals increase usage.",
  ...
  ja: {
    title: "画面共有",
    description: "通話の小窓はそのままに、作業画面のそばで共有を操作できます。",
    display: "共有する画面",
    noDisplays: "共有できる画面がありません",
    refresh: "画面一覧を更新",
    interval: "画面を見る間隔",
    seconds: (value: number) => `${value}秒`,
    cost: "画面共有は画像の送信でトークンを消費します。間隔が短いほど使用量が増えます。",
